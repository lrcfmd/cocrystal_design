...
The aim of this work is to introduce the concept of One Class Classification and its application in a co-crystal design problem as described in our paper [One class classification as a practical approach for accelerating π–π co-crystal discovery](https://pubs.rsc.org/en/content/articlelanding/2021/sc/d0sc04263c#!divAbstract). A very important problem that currrent data driven approaches for materials discovery faces is the lack of negative data i.e., data for experiments that didn’t work or materials that cannot be formed. This  drives to the excistence of extremely biased materials datasets. Instead of trying to gather negative data, that might be an expensive or unreliable process, one class classification aims to extract the trends that dominate the known and reliable data and be able to predict similar structures that could be synthesizable. 
